...
# Day 0 coincides with the tutorial round → 8d; Day 1 → 7d; Day 2 → 6d.
DAY_TO_TTE: Dict[int, float] = {0: 8.0, 1: 7.0, 2: 6.0}
...
def load_day(data_dir: str, day: int) -> Tuple[pd.DataFrame, pd.DataFrame]:
    p_path = os.path.join(data_dir, f"prices_round_3_day_{day}.csv")
    t_path = os.path.join(data_dir, f"trades_round_3_day_{day}.csv")
