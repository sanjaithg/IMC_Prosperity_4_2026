...
class Trader:
    ...
    def trade_osmium(self, od: OrderDepth, pos: int, lim: int) -> List[Order]:
        ...
        # ── EMA FAIR VALUE CALCULATION (Kept for background tracking) ──
        mid = None
        ...
        # Sweeps the book but caps strictly at +/- 60 based on price extremes.
        # Leaves at least 20 inventory slots for passive market making.
        # =====================================================================
            ...
            for bid_price in sorted(od.buy_orders.keys(), reverse=True):
                if bid_price >= 10005:
                    if bid_price >= 10010:
                        ...
                        # Interpolate between 10005 (-10) and 10010 (-60)
            ...
            for ask_price in sorted(od.sell_orders.keys()):
                if ask_price <= 9995:
                    if ask_price <= 9900:
                        ...
                        # Interpolate between 9995 (+10) and 9900 (+60)
        ...
        # Uses the absolute limit (80) to soak up the final 20 slots passively.
        # =====================================================================
